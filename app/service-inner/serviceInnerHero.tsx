  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative min-h-screen grid md:grid-cols-2 items-center p-4 md:p-8 gap-8">
        {/* Left Column - Text */}
        <div className="text-white space-y-4 md:pl-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Industrial Cleaning Excellence
          </h1>
          <p className="text-lg opacity-90">
            Expert industrial and commercial cleaning services tailored to your
            facilitys needs. Professional, reliable, and thorough cleaning
            solutions.
          </p>
        </div>
