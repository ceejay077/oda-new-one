                  ...
                  <li>
                    <figure className="relative rounded-md bg-TestimonialsBlue p-6 shadow-slate-900/10">
                      ...
                      <blockquote className="relative">
                        <h4 className={`font-bold mb-5 black-blue ${interfont.className}`}>{testimonial.title}</h4>
                      ...
                      <figcaption className="relative mt-6 flex items-center border-t border-slate-100 pt-6">
                        ...
                        <div>
                          <div className={`font-display font-bold text-base text-slate-900 ml-4 ${interfont.className}`}>
                            {testimonial.author}
