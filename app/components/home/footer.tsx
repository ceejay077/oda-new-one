    ...
    <div>
      <div className=" bg-CTRbg pt-9">
        <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
          <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
            ...
            <div className="md:w-[316px]">
              ...
              <div className="mt-[23px] flex">
                ...
                <div className="ml-[18px]">
                  <a
                    href="https://www.google.com/maps/place/Sub+Nerul,+Mumbia,+India,+123456"
                    className="font-Inter text-[14px] font-medium text-white"
                  >
            ...
            <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
              ...
              <div className="mt-6 flex flex-col gap-4 sm:mt-0">
                <p className="text-white font-inter text-[18px] font-medium">
                  Download the app
                </p>
          ...
          <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8"></div>
        </div>
      </div>
    </div>
  );
